...
- **Pendiente arrastrado**: `/promote` masivo (7 bitácoras `promoted: false` ahora); matriz E1–E6 (`docs/14`); Gate 8 screenshots; self-heal NOGROUP live; doc de fallo F4 "auto limitado por el modelo" → superado por re-sourcing + queda como "limitado por sourcing", que C cierra.
