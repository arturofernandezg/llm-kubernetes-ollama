...
| **Total** | **621** | | **pytest colecta 621** (parametrize expande ~5). **Jay-confirmado 621 verde 2026-07-06** (620 el 07-04 + 1 el 07-06). Incluye el bloque RAG F4 (R2/R2·3/R3 + gate E4), F-01/02/04/05, F-03 y el test de paridad R2-humano. Corridos en el gate de Cloud Build de `0914611` (desplegado). |
