...
| **Total** | **460** | | 460 funciones `def test_` en 14 ficheros. F3: `test_remediation.py` 137→175 (+38: dimensión CPU, field-agnostic, auto-CPU tras flag, re-sourcing estructurado). *(+1 test de temp=0 staged en `test_diagnosis.py`, pytest pendiente → 461.)* |
