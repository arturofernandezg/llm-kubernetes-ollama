...
| **Total** | **565** | | 565 funciones `def test_` en **15 ficheros** (conteo `grep -c "def test"` 2026-07-03). *(Los ~9 de la sesión 2026-07-03 — F-05 ×2, F-01 ×6, F-04 ×1 — pendientes de pytest por Jay; el resto verde en el gate de Cloud Build de `cb2d1db`.)* |
