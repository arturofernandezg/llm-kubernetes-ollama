...
| **Total** | **695** | | **pytest colecta ~700** (parametrize expande ~5). Verde Jay-confirmado 2026-07-11 con 691; **S7 (2026-07-13) añadió ~4** (audit ×2, C-08 render/sanitize ×2 — ver bullet S7 abajo), **pendiente re-confirmar el pytest full antes del 15**. Los builds de S7 (`7e40837`, `2ac3c5d`) pasaron el gate de Cloud Build. |
