...
- **Tests**: 460 funciones en 14 ficheros, mockeados (cola con `AsyncMock` — `FakeRedis` no soporta streams); Cloud Build los corre como gate. *(+1 test de temp=0 staged, pytest pendiente.)*
